...
public class main {
    public static void main(String[] args) {
        ...
        Pixel_198538736_GuajardoArias PB = new Pixel_198538736_GuajardoArias(0, 1, 1, myColor2);
        Pixel_198538736_GuajardoArias PC = new Pixel_198538736_GuajardoArias(1, 0, 1, myColor3);
        ...
        if(myImage.isBitmap()){
            ...
            System.out.println("definitely nope");
        }
